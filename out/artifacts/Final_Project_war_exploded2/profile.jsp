...
<div class="text">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <form id="remove-loan<%= counter %>" method="post" action="LoanServlet">
                    <input type="hidden" name="cc" value="<%= l.copy.copyCode %>">
                    <input type="submit" value="delete">
                </form>
                <script>
                    $("#remove-loan<%= counter %>").bind("submit", function (e) {
            ...
            <td>
                <form id="show-book<%= counter %>" method="get" action="pdf-view.jsp">
                    <input type="hidden" name="isbn" value="<%= l.copy.book.isbn %>">
    ...
    <form id="add-book" action="BookServlet" method="post" enctype="multipart/form-data">
        <table>
            <tr>
                ...
                <td><label for="content" class="label">Image - </label></td>
            </tr>
            <tr>
