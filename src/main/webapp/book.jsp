...
<br>
<h1 class="text" style="text-align:center"><%= b.bookName %>
</h1>
<br>
<div class="text">
    <table>
    ...
    <table>
        ...
        <tr>
            ...
            <td id="loaned<%= c.copyCode %>"><%= c.loaned %>
            </td>


            <% if (u.auth != 0 && !c.loaned) { %>
            <td id="<%= c.copyCode %>">
                <form id="loan<%= c.copyCode %>" action="LoanServlet">
                    <input type="hidden" name="cc" value="<%= c.copyCode %>">
                    <input type="submit" value="loan">
                </form>
                <script>
                    $("#loan<%= c.copyCode %>").bind("submit", function (e) {
                        e.preventDefault();
                        $.ajax({
                            type: "Get",
                            url: "LoanServlet",
